...
#include <Arduino_BMI270_BMM150.h> /* 1.2.1 installed */
...
// Apply offsets directly to the data struct
        // data.mx -= magX_offset;
        // data.my -= magY_offset;
        // data.mz -= magZ_offset;
  ...
  data.mx = (data.mx +18.50)/50.50;
  data.my = (data.my  +2.50)/46.50;
  data.mz = (data.mz +18.00)/53.00;
...
//         // Calculate Yaw from Magnetometer (Basic approach)
